  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x06, 0x9e, 0x73, 0x45, 0x3c, 0x79, 0xc5, 0x4b,
      0x52, 0xde, 0x73, 0xbc, 0xd5, 0xc3, 0x3b, 0x00,
      0xe8, 0x75, 0x75, 0xba, 0x7d, 0x18, 0xa4, 0x1d,
      0x06, 0xde, 0xf2, 0x39, 0xa6, 0x6c, 0xb9, 0x7e,
    }};
  return &hash;
}
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__EstimatorStatusFlags__FIELDS, 69, 69},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__EstimatorStatusFlags__TYPE_NAME, 33, 33},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 7123, 7123},
  };
  return &source;
}
